...
class FunkinButton extends FunkinSprite implements IFlxInput
{
   ...
   */
  public var currentInput:IFlxInput;
  ...
  public function checkTouchOverlap(?touch:FlxTouch):Bool
  {
  ...
  public function polygonOverlapsPoint(point:FlxPoint, inScreenSpace:Bool = false, ?camera:FlxCamera):Bool
  {
  ...
  public static function isPointInPolygon(vertices:Array<Float>, point:FlxPoint, ?offset:FlxPoint):Bool
  {
  ...
  public function isPressed(check:Bool):Bool
  {
    return !(status != FunkinButtonStatus.NORMAL && (!check || (currentInput != null && currentInput.justReleased)));
  }

  public function updateStatus(newInput:IFlxInput):Void
  {
  ...
  public function drawDebugCircleColor(gfx:Graphics, color:FlxColor):Void
  {
    gfx.lineStyle(2, color, 0.75);
    gfx.drawCircle(radius, radius, radius);
  }

  public function drawDebugPolygonColor(gfx:Graphics, vertices:Array<Float>, color:FlxColor):Void
  {
    gfx.lineStyle(2, color, 0.75);
