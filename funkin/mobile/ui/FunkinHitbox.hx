...
class FunkinHint extends FunkinButton
{
   ...
   */
  public static final HINT_ALPHA_STYLE:Map<FunkinHintAlphaStyle, Array<Float>> = [
   ...
   */
  public var noteDirection:NoteDirection;

  /**
   * The label associated with the button.
   */
  public var label:Null<FunkinSprite>;

  /**
   * The tween used to animate the alpha changes of the button.
   */
  public var labelAlphaTween:Null<FlxTween>;
   ...
   * The tween used to animate the alpha changes of the button.
   */
  public var alphaTween:Null<FlxTween>;

  public var followTarget:Null<FunkinSprite>;

  public var followTargetSize:Bool = false;
...
class FunkinHitbox extends FlxTypedSpriteGroup<FunkinHint>
{
   ...
   */
  public function createHintCircle(x:Float, y:Float, noteDirection:NoteDirection, radius:Float, outlineThickness:Int, color:FlxColor = 0xFFFFFFFF):FunkinHint
  {
    final hint:FunkinHint = new FunkinHint(x, y, noteDirection, null);
   ...
   * @return A new `FunkinHint` object.
   */
  public function createHintTransparentNote(x:Float, y:Float, noteDirection:NoteDirection, width:Int, height:Int):FunkinHint
  {
    final hint:FunkinHint = new FunkinHint(x, y, noteDirection, null);
    hint.alpha = 0;
   ...
   */
  public function createHintLaneGraphic(width:Int, height:Int, baseColor:FlxColor = 0xFFFFFFFF, gradient:Bool = true):FlxGraphic
  {
  ...
  public function createHintLaneLabelGraphic(width:Int, height:Int, labelHeight:Int, baseColor:FlxColor = 0xFFFFFFFF):FlxGraphic
  {
    final shape:Shape = new Shape();
   ...
   */
  public function createHintTriangleGraphic(width:Int, height:Int, facing:NoteDirection, baseColor:FlxColor = 0xFFFFFFFF, gradient:Bool = true):FlxGraphic
  {
    final shape:Shape = new Shape();
   ...
   */
  public function createHintCircleGraphic(radius:Float, outlineThickness:Int, baseColor:FlxColor = 0xFFFFFFFF):FlxGraphic
  {
   ...
   */
  public function getTriangleVertices(width:Int, height:Int, facing:NoteDirection):Array<Float>
  {
