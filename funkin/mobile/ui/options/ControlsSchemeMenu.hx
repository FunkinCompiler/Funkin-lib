...
class ControlsSchemeMenu extends MusicBeatSubState
{
   ...
   */
  public var hsv:HSVShader = new HSVShader();
   ...
   */
  public function setupHitboxShowcases():Void
  {
   ...
   */
  public function createButton(isDemoScreen:Bool):Void
  {
   ...
   */
  public function onSelectHitbox():Void
  {
   ...
   */
  public function onHitboxDemo():Void
  {
    isInDemo = true;
   ...
   */
  public function onHitboxDemoBack():Void
  {
    isInDemo = false;
