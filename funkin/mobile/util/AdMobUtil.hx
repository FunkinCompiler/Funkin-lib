...
class AdMobUtil
{
   ...
   */
  @:envField
  public static final ADMOB_PUBLISHER:Null<String>;

  /**
   * Ad unit ID for displaying banner ads.
   */
  @:envField
  public static final ADMOB_BANNER_AD_UNIT_ID:Null<String>;

  /**
   * Ad unit ID for displaying interstitial ads.
   */
  @:envField
  public static final ADMOB_INTERSTITIAL_AD_UNIT_ID:Null<String>;
  #else
   ...
   */
  public static final ADMOB_BANNER_AD_UNIT_ID:String = #if android "9214589741" #elseif ios "2435281174" #else "" #end;
   ...
   */
  public static final ADMOB_INTERSTITIAL_AD_UNIT_ID:String = #if android "1033173712" #elseif ios "4411468910" #else "" #end;
  #end
