...
class InitState extends FlxState
{
   ...
   */
  @:noCompletion
  public static var _coreInitialized:Bool = false;
  ...
  public function defineSong():Null<String>
  {
    return MacroUtil.getDefine('SONG');
  }

  public function defineLevel():Null<String>
  {
    return MacroUtil.getDefine('LEVEL');
  }

  public function defineDifficulty():Null<String>
  {
