 ...
 */
#if hxvlc
class ScriptedFunkinVideoSprite extends funkin.graphics.video.FunkinVideoSprite {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFunkinVideoSprite type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFunkinVideoSprite
   */
  public static function init(className:String,...args:Any):ScriptedFunkinVideoSprite {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFunkinVideoSprite.
