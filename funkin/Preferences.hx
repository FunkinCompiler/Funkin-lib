...
class Preferences
{
  ...
  public static function get_debugDisplay():DebugDisplayMode
  {
    #if mobile
  ...
  public static function set_debugDisplay(value:DebugDisplayMode):DebugDisplayMode
  {
    var string;
  ...
  public static function get_debugDisplayBGOpacity():Int
  {
    return Save?.instance?.options?.debugDisplayBGOpacity ?? 50;
  }

  public static function set_debugDisplayBGOpacity(value:Int):Int
  {
  ...
  public static function get_hapticsMode():HapticsMode
  {
  ...
  public static function set_hapticsMode(value:HapticsMode):HapticsMode
  {
    var string;
  ...
  public static function get_hapticsIntensityMultiplier():Float
  {
    return Save?.instance?.options?.hapticsIntensityMultiplier ?? 1;
  }

  public static function set_hapticsIntensityMultiplier(value:Float):Float
  {
    var save:Save = Save.instance;
  ...
  public static function get_autoFullscreen():Bool
  {
    return Save?.instance?.options?.autoFullscreen ?? true;
  }

  public static function set_autoFullscreen(value:Bool):Bool
  {
    var save:Save = Save.instance;
  ...
  public static function get_globalOffset():Int
  {
    return Save?.instance?.options?.globalOffset ?? 0;
  }

  public static function set_globalOffset(value:Int):Int
  {
    var save:Save = Save.instance;
  ...
  public static function get_vsyncMode():lime.ui.WindowVSyncMode
  {
  ...
  public static function set_vsyncMode(value:lime.ui.WindowVSyncMode):lime.ui.WindowVSyncMode
  {
    var string;
  ...
  public static function get_strumlineBackgroundOpacity():Int
  {
    return (Save?.instance?.options?.strumlineBackgroundOpacity ?? 0);
  }

  public static function set_strumlineBackgroundOpacity(value:Int):Int
  {
    var save:Save = Save.instance;
  ...
  public static function get_shouldHideMouse():Bool
  {
    return Save?.instance?.options?.screenshot?.shouldHideMouse ?? true;
  }

  public static function set_shouldHideMouse(value:Bool):Bool
  {
    var save:Save = Save.instance;
  ...
  public static function get_fancyPreview():Bool
  {
    return Save?.instance?.options?.screenshot?.fancyPreview ?? true;
  }

  public static function set_fancyPreview(value:Bool):Bool
  {
    var save:Save = Save.instance;
  ...
  public static function get_previewOnSave():Bool
  {
    return Save?.instance?.options?.screenshot?.previewOnSave ?? true;
  }

  public static function set_previewOnSave(value:Bool):Bool
  {
    var save:Save = Save.instance;
  ...
  public static function setDebugDisplayBGOpacity(value:Float):Void
  {
  ...
  public static function get_screenTimeout():Bool
  {
    return Save?.instance?.mobileOptions?.screenTimeout ?? false;
  }

  public static function set_screenTimeout(value:Bool):Bool
  {
  ...
  public static function get_controlsScheme():String
  {
    return Save?.instance?.mobileOptions?.controlsScheme ?? FunkinHitboxControlSchemes.Arrows;
  }

  public static function set_controlsScheme(value:String):String
  {
    var save:Save = Save.instance;
  ...
  @:unreflective
  public static function get_noAds():Bool
  {
  ...
  @:unreflective
  public static function set_noAds(value:Bool):Bool
  {
    var save:Save = Save.instance;
