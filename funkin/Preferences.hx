...
class Preferences
{
  ...
  public static function get_saveFormat():Any
  {
    return Save?.instance?.options?.screenshot?.saveFormat ?? 'PNG';
  }

  public static function set_saveFormat(value):Any
  {
    var save:Save = Save.instance;
  ...
  public static function get_jpegQuality():Int
  {
    return Save?.instance?.options?.screenshot?.jpegQuality ?? 80;
  }

  public static function set_jpegQuality(value:Int):Int
  {
    var save:Save = Save.instance;
