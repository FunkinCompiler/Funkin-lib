...
class GameOverSubState extends MusicBeatSubState
{
  ...
  public var justDied:Bool = true;

  public var isSpecialAnimation:Bool = false;

  public var gameOverVibrationPreset:VibrationPreset =
    {
      period: 0,
  ...
  public var deathQuoteSound:Null<FunkinSound> = null;

  public function playDeathQuote():Void
  {
    if (isEnding) return;
  ...
  public var hasPlayedDeathQuote:Bool = false;

  /**
   * Used for death haptics.
   */
  public var startedTimerHaptics:Bool = false;

  /**
   * Unique vibrations for each death animation.
   */
  public function handleAnimationVibrations():Void
  {
    if ((parentPlayState?.isMinimalMode ?? true) || boyfriend == null) return;
