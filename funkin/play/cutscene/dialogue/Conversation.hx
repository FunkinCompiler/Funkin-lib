...
class Conversation extends FlxSpriteGroup implements IDialogueScriptedClass implements IRegistryEntry<ConversationData>
{
  ...
  * **/
  ...
  public var currentDialogueEntryData(get, never):Null<DialogueEntryData>;

  public function get_currentDialogueEntryData():Null<DialogueEntryData>
  {
   ...
   * AUDIO
   */
  public var music:Null<FunkinSound>;

  /**
   * GRAPHICS
   */
  public var backdrop:Null<FunkinSprite>;

  public var currentSpeaker:Null<Speaker>;

  public var currentDialogueBox:Null<DialogueBox>;
  ...
  public var outroTween:Null<FlxTween> = null;
