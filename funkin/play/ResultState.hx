...
class ResultState extends MusicBeatSubState
{
  ...
  public var blackTopBar:FlxSprite = new FlxSprite();
  ...
  public function transitionToState(targetState:FlxState, targetStateFactory:Null<Void->StickerSubState>, shouldTween:Bool, shouldUseSubstate:Bool):Void
  {
    if (shouldTween)
    {
