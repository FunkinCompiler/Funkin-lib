...
class PauseSubState extends MusicBeatSubState
{
  ...
  public var dataFadeTimer = new FlxTimer();
  public var hapticTimer = new FlxTimer();
  ...
  public function transitionMetadataIn():Void
  {
  ...
  // Input Handling
  // ===============
  public var fastOffset:Bool = false;
  public var lastOffsetPress:Float = 0;
