...
class PlayState extends MusicBeatSubState
{
   ...
   */
  public static var lastParams:Null<PlayStateParams>;
  ...
  **/
  ...
  public function get_currentChart():Null<SongDifficulty>
  {
   ...
   */
  public static final MUSIC_EASE_RATIO:Float = 42;
  ...
  public function pause(mode:PauseMode = Standard):Void
  {
  ...
  public function preparePauseUI():Void
  {
    #if mobile
    FlxTween.cancelTweensOf(pauseButton);
    FlxTween.cancelTweensOf(pauseCircle);
  ...
  public function openPauseSubState(mode:PauseMode, cam:FlxCamera, ?onPause:Void->Void):Void
  {
  ...
  /**
     ...
     */
  #if mobile
  public function initNoteHitbox()
  {
  ...
  public function initPauseSprites()
  {
  ...
  public var prevScrollTargets:Array<Dynamic> = []; // used to snap scroll speed when things go unruly
  ...
  public function forEachPausedSound(f:FlxSound->Void):Void
  {
