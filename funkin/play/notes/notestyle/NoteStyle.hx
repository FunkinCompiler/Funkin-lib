...
class NoteStyle implements IRegistryEntry<NoteStyleData>
{
  ...
  public var splashFrames:Null<FlxAtlasFrames> = null;

  public function buildSplashFrames(force:Bool = false):Null<FlxAtlasFrames>
  {
  ...
  public function buildSplashAnimations(target:NoteSplash):Void
  {
  ...
  public function fetchSplashAnimationData(dir:NoteDirection):Null<Array<AnimationData>>
  {
  ...
  public var holdCoverFrames:Null<FlxFramesCollection> = null;

  public function buildHoldCoverFrames(force:Bool = false):Null<FlxFramesCollection>
  {
  ...
  public function buildHoldCoverFrameForDirection(direction:NoteDirection):Null<FlxFramesCollection>
  {
  ...
  public function buildHoldCoverAnimations(target:NoteHoldCover):Void
  {
    for (direction in Strumline.DIRECTIONS)
    {
  ...
  public function fetchHoldCoverAnimationData(dir:NoteDirection):Null<Array<AnimationData>>
  {
  ...
  public function getHoldCoverRootAssetPath(direction:NoteDirection, raw:Bool = false):Null<String>
  {
    if (raw)
    {
   ...
   */
  public function getAssetLibrary(?id:String):Null<String>
  {
