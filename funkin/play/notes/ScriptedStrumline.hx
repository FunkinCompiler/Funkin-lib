 ...
 */
class ScriptedStrumline extends funkin.play.notes.Strumline {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedStrumline type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedStrumline
   */
  public static function init(className:String,...args:Any):ScriptedStrumline {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedStrumline.
