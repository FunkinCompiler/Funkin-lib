 ...
 */
class ScriptedStageProp extends funkin.play.stage.StageProp {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedStageProp type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedStageProp
   */
  public static function init(className:String,...args:Any):ScriptedStageProp {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedStageProp.
