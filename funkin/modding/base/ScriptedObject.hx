 ...
 */
class ScriptedObject extends funkin.modding.base.Object {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedObject type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedObject
   */
  public static function init(className:String,...args:Any):ScriptedObject {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedObject.
