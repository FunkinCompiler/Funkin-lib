 ...
 */
class ScriptedFlxStrip extends flixel.FlxStrip {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFlxStrip type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFlxStrip
   */
  public static function init(className:String,...args:Any):ScriptedFlxStrip {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxStrip.
