 ...
 */
class ScriptedFlxTypedGroup extends flixel.group.FlxGroup.FlxTypedGroup<Dynamic> {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFlxTypedGroup type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFlxTypedGroup
   */
  public static function init(className:String,...args:Any):ScriptedFlxTypedGroup {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxTypedGroup.
