...
class ScriptedFlxBasic extends flixel.FlxBasic {
   ...
   * @param className Name of the target class extending ScriptedFlxBasic type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFlxBasic
   */
  public static function init(className:String,...args:Any):ScriptedFlxBasic {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxBasic.
