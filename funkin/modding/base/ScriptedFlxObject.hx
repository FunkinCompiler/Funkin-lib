 ...
 */
class ScriptedFlxObject extends flixel.FlxObject {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedFlxObject type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedFlxObject
   */
  public static function init(className:String,...args:Any):ScriptedFlxObject {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedFlxObject.
