...
typedef RegistryTypeParams =
{
   ...
   */
  public var entryType:ClassType;

  /**
   * The type for the data of an entry. This is usually a typedef of a struct.
   */
  public var dataType:Any; // DefType or ClassType
...
{
  #if ios
  public static final DATA_FILE_BASE_PATH:String = "../../../../../assets/preload/data";
  #else
  public static final DATA_FILE_BASE_PATH:String = "assets/preload/data";
  #end
   ...
   */
  public static function getTypeParams(cls:ClassType):RegistryTypeParams
  {
   ...
   * @return The modified list of fields for the target class.
   */
  public static function buildRegistryMethods(cls:ClassType, fields:Array<Field>, entryType:ClassType, dataType:Dynamic):Array<Field>
  {
   ...
   */
  public static function getEntryData(cls:ClassType):Any // DefType or ClassType
  {
    try
    {
   ...
   * @return The modified list of fields for the target class.
   */
  public static function buildEntryVariables(cls:ClassType, entryData:Dynamic):Array<Field>
  {
   ...
   * @return The modified list of fields for the target class.
   */
  public static function buildEntryMethods(cls:ClassType):Array<Field>
  {
   ...
   */
  public static function buildEntryImpl(cls:ClassType, registryCls:ClassType):Void
  {
  ...
  public static function getRegistryDataFilePath(cls:ClassType, fields:Array<Field>):String
  {
    for (field in fields)
    {
      if (field.name == 'new')
   ...
   */
  public static function alreadyProcessed(cls:ClassType):Bool
  {
