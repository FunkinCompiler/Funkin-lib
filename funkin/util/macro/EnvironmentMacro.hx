...
class EnvironmentMacro
{
  ...
  #if macro
  public static function parseEnvFile(envPath:String):Map<String, String>
  {
  ...
  public static function shouldExcludeKey(key:String):Bool
  {
  ...
  public static function stripTargetPrefix(key:String):String
  {
