...
class ScreenshotPlugin extends FlxBasic
{
  ...
  public var screenshotSpammedTimer:FlxTimer;
  ...
  public var previewFadeInTween:FlxTween;
  public var previewFadeOutTween:FlxTween;

  public var asyncLoop:FlxAsyncLoop;
  ...
  public var previousScreenshotName:String;
  public var previousScreenshotCopyNum:Int;
   ...
   */
  public function saveScreenshot(bitmap:Bitmap, targetPath = "image", screenShotNum:Int = 0, delaySave:Bool = true)
  {
    makeScreenshotPath();
  ...
  public function saveBufferedScreenshots(screenshots:Array<Bitmap>, screenshotNames)
  {
   ...
   */
  public function saveUnsavedBufferedScreenshots()
  {
    stateChanging = true;
  ...
  public function postStateSwitch()
  {
    stateChanging = false;
    screenshotBeingSpammed = false;
    FlxG.stage.removeChild(previewSprite);
