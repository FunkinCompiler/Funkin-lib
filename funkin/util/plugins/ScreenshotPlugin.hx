...
class ScreenshotPlugin extends FlxBasic
{
  ...
  public static var _instance:Null<ScreenshotPlugin> = null;

  public static function get_instance():ScreenshotPlugin
  {
    if (_instance == null)
    {
  ...
  public var region:Null<Rectangle>;
  ...
  public static var lastWidth:Int = 0;
  public static var lastHeight:Int = 0;

  public var flashSprite:Sprite;
  public var flashBitmap:Bitmap;
  public var previewSprite:Sprite;
  public var shotPreviewBitmap:Bitmap;
  public var outlineBitmap:Bitmap;

  public var wasMouseHidden:Bool = false; // Used for hiding and then showing the mouse
  public var wasMouseShown:Bool = false; // Used for showing and then hiding the mouse
  public var screenshotTakenFrame:Int = 0;

  public var screenshotBeingSpammed:Bool = false;

  public var screenshotSpammedTimer:Null<FlxTimer> = null;

  public var screenshotBuffer:Array<Bitmap> = [];
  public var screenshotNameBuffer:Array<String> = [];

  public var unsavedScreenshotBuffer:Array<Bitmap> = [];
  public var unsavedScreenshotNameBuffer:Array<String> = [];

  public var stateChanging:Bool = false;
  public var noSavingScreenshots:Bool = false;

  public var flashTween:Null<FlxTween> = null;

  public var previewFadeInTween:Null<FlxTween> = null;
  public var previewFadeOutTween:Null<FlxTween> = null;

  public var asyncLoop:Null<FlxAsyncLoop> = null;
  ...
  public function resizeBitmap(width:Int, height:Int):Void
  {
    lastWidth = width;
    lastHeight = height;
   ...
   */
  public function showFancyPreview(shot:Bitmap):Void
  {
   ...
   */
  public function previewSpriteOpenScreenshotsFolder(e:MouseEvent):Void
  {
    if (previewSprite.alpha <= 0) return;
    openScreenshotsFolder();
  }

  public function openScreenshotsFolder():Void
  {
    FileUtil.openFolder(SCREENSHOT_FOLDER);
  }

  // Save them, save the screenshots
  public function onWindowClose(exitCode:Int):Void
  {
    if (noSavingScreenshots) return; // sike
    saveUnsavedBufferedScreenshots();
  }

  public function onWindowCrash(message:String):Void
  {
   ...
   */
  public function encode(bitmap:Bitmap):ByteArray
  {
    var compressor:PNGEncoderOptions = new PNGEncoderOptions();
    return bitmap.bitmapData.encode(bitmap.bitmapData.rect, compressor);
  }

  public var previousScreenshotName:Null<String> = null;
  public var previousScreenshotCopyNum:Int = 0;
   ...
   */
  public function saveScreenshot(bitmap:Bitmap, targetPath = "image", screenShotNum:Int = 0, delaySave:Bool = true):Void
  {
    makeScreenshotPath();
  ...
  public function saveBufferedScreenshots(screenshots:Array<Bitmap>, screenshotNames:Array<String>):Void
  {
   ...
   */
  public function saveUnsavedBufferedScreenshots():Void
  {
    stateChanging = true;
