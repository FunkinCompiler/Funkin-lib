...
extern class WinAPI
{
  ...
  public static function showError(message:cpp.ConstCharStar, title:cpp.ConstCharStar):Void;
  ...
  public static function showWarning(message:cpp.ConstCharStar, title:cpp.ConstCharStar):Void;
  ...
  public static function showInformation(message:cpp.ConstCharStar, title:cpp.ConstCharStar):Void;
  ...
  public static function showQuestion(message:cpp.ConstCharStar, title:cpp.ConstCharStar):Void;
