...
class DifficultyDot extends FlxSpriteGroup
{
  ...
  public var normalColors:Array<FlxColor> = [0xFF484848, 0xFFFAFAFA, 0xFF919191, 0xFFC9C9C9];
  public var nightColors:Array<FlxColor> = [0xFF34296A, 0xFFC28AFF, 0xFF8A58D0, 0xFFFFB1DC];

  public var important:Bool = false;

  public var pulseColor = false;
