 ...
 */
class ScriptedBackingCard extends funkin.ui.freeplay.backcards.BackingCard {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedBackingCard type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedBackingCard
   */
  public static function init(className:String,...args:Any):ScriptedBackingCard {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedBackingCard.
