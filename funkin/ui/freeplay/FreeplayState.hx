...
class FreeplayState extends MusicBeatSubState
{
  ...
  public var curSelectedFloat:Float = 0;
  ...
  public var difficultyDots:FlxTypedSpriteGroup<DifficultyDot>;
   ...
   */
  public var currentDifficultySprite(get, never):DifficultySprite;

  public function get_currentDifficultySprite():DifficultySprite
  {
    return grpDifficulties.members.filter(d -> d.difficultyId == currentDifficulty)[0];
  }
  ...
  public function get_currentCapsule():SongMenuItem
  {
  ...
  public var djHitbox:FlxObject = new FlxObject((CUTOUT_WIDTH * DJ_POS_MULTI), 320, 400, 400);
  public var capsuleHitbox:FlxObject = new FlxObject((CUTOUT_WIDTH * SONGS_POS_MULTI) + 380, 150, CUTOUT_WIDTH + 590, 576);
  #end
  ...
  public var diffSelLeft:DifficultySelector;
  public var diffSelRight:DifficultySelector;
  ...
  public var forceSkipIntro:Bool = false;
  ...
  public function rankAnimStart(fromResults:FromResultsParams, capsuleToRank:SongMenuItem):Void
  {
    controls.active = false;
  ...
  public function rankDisplayNew(fromResults:Null<FromResultsParams>, capsuleToRank:SongMenuItem):Void
  {
  ...
  public function rankAnimSlam(fromResultsParams:Null<FromResultsParams>, capsuleToRank:SongMenuItem):Void
  {
  ...
  public var prevDotAmount:Int = 0;

  public function fadeDots(fadeIn:Bool):Void
  {
  ...
  public function refreshDots(amount:Int, index:Int, prevIndex:Int):Void
  {
    var distance:Int = 30;
  ...
  public var allowPicoBulletsVibration:Bool = false;

  public var backTransitioning:Bool = false;
  ...
  public function lerpScoreDisplays():Void
  {
  ...
  public var _dragOffset:Float = 0;
  public var _prevRoundedDragOffset:Float = 0;
  public var _pressedOnSelected:Bool = false;
  public var _moveLength:Float = 0;
  public var _flickEnded:Bool = true;
  public var _pressedOnCapsule:Bool = false;
  public var draggingDifficulty:Bool = false;
  ...
  public function handleDirectionalInput(elapsed:Float):Void
  {
  ...
  public function handleDifficultySwitch():Void
  {
    #if FEATURE_TOUCH_CONTROLS
  ...
  public function handleDebugKeys():Void
  {
  ...
  #if FEATURE_TOUCH_CONTROLS
  public function handleTouchCapsuleClick():Void
  {
  ...
  public function handleTouchSelectionScroll(elapsed:Float):Void
  {
  ...
  public function handleTouchFavoritesAndDifficulties()
  {
   ...
   * @return Int
   */
  public function findClosestDiff(characterVariations:Array<String>, diff:String):Int
  {
   ...
   * @param capsuleAnim
   */
  public function changeDiff(change:Int = 0, force:Bool = false, capsuleAnim:Bool = false):Void
  {
    if (capsuleAnim)
    {
  ...
  #if FEATURE_TOUCH_CONTROLS
  public function handleDiffDragRelease(diff:FlxSprite):Void
  {
  ...
  public function handleDiffBoundaryChange(change:Int):Void
  {
    if (!controls.active) return;
    dj?.resetAFKTimer();
    changeDiff(change);
   ...
   */
  public function capsuleOnOpenRandom(randomCapsule:SongMenuItem):Void
  {
   ...
   */
  public function capsuleOnConfirmRandom(availableSongCapsules:Array<SongMenuItem>, instChoice:String):Void
  {
  ...
  public function updateSongsScroll():Void
  {
  ...
  public function favoriteSong():Void
  {
...
class FreeplaySongData
{
  ...
  public function get_idAndVariation()
  {
    return '${data.id}:${curVariation}';
  }

  public function get_isFav():Bool
  {
  ...
  public function get_curVariation()
  {
