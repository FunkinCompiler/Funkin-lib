...
class SongMenuItem extends FlxSpriteGroup
{
  ...
  public var difficultyNumbers:Array<CapsuleNumber> = []; // referred to as "bignumbers" in the .fla file!
  public var bpmNumbers:Array<CapsuleNumber> = []; // referred to as "smallnumbers" in the .fla file!
  ...
  public var xPosLerpLol:Array<Float> = [0, 0, 0.16, 0.16, 0.22, 0.22, 0.245]; // NUMBERS ARE JANK CUZ THE SCALING OR WHATEVER
  ...
  public function set_forceHighlight(value:Bool):Bool
  {
    // cute one liners, lol!
