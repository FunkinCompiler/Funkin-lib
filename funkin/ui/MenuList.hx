...
class MenuTypedList<T:MenuListItem> extends FlxTypedGroup<T>
{
  ...
  // Helper variable
  public var _isMainMenuState:Bool = false;
...
class MenuListItem extends FlxSprite
{
  ...
  public function setData(name:String, ?callback:Void->Void, available:Bool):Void
  {
    this.name = name;
...
class MenuTypedItem<T:FlxSprite> extends MenuListItem
{
  ...
  public function set_label(value:Null<T>):Null<T>
  {
    if (value != null)
    {
      value.x = x;
