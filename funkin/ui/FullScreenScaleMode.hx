...
class FullScreenScaleMode extends flixel.system.scaleModes.BaseScaleMode
{
  ...
  public function updateDeviceCutout(Width:Int, Height:Int):Void
  {
    if (enabled)
    {
  ...
  #if mobile
  public function updateDeviceNotch(notch:lime.math.Rectangle):Void
  {
  ...
  public function adjustGameSize():Void
  {
