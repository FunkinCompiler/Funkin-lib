...
typedef ArrowData =
{
  ...
  public var direction:Int; // 0 = left, 1 = down, 2 = up, 3 = right
};
...
class OffsetMenu extends Page<OptionsState.OptionsMenuPageName>
{
  ...
  public var appliedOffsetLerp:Float = 0;
  public var savedOffset:Int = 0;
  public var tempOffset:Int = 0;

  // Variables for transitioning between states
  public var lerped:Float = 0;
  public var shouldOffset:Int = 0;
  public var offsetLerp:Float = 0;
  public var scaleModifier:Float = 1;

  // Variables for keeping time and beat
  public var localConductor:Conductor;
  public var arrowBeat:Float = 0;

  // Variables for differences and consistency functionality
  public var _gotMad:Bool = false;
  public var differences:Array<Float> = [];

  public var msPerBeat(get, never):Float;

  // The milliseconds per beat, calculated from the BPM.
  public function get_msPerBeat():Float
  {
    return 60000 / BPM;
  }
  ...
  **/
  ...
  public var _offsetLerpTime:Float = 0;
  public var _lastOffset:Float = 0;
  public var _lastDirection:Int = 0;
  ...
  public var _lastBeat:Float = 0;
  public var _lastTime:Float = 0;
  ...
  public function hitNote(note:NoteSprite, input:PreciseInputEvent):Void
  {
  ...
  public function createButtonItem(name:String, callback:Void->Void):Void
  {
