...
class OptionsState extends MusicBeatState
{
  ...
  public var optionsCodex:Codex<OptionsMenuPageName>;
  ...
  public function exitOffsets():Void
  {
    if (drumsBG.volume > 0)
    {
...
class OptionsMenu extends Page<OptionsMenuPageName>
{
   ...
   * Camera focus point
   */
  public var camFocusPoint:FlxObject;
  ...
  public function onMenuChange(selected:TextMenuItem):Void
  {
    camFocusPoint.y = selected.y;
  }

  public function createItem(name:String, callback:Void->Void, fireInstantly = false):TextMenuItem
  {
  ...
  public function promptClearSaveData():Void
  {
