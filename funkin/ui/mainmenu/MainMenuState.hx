...
class MainMenuState extends MusicBeatState
{
  ...
  public var goingToOptions:Bool = false;
  public var goingBack:Bool = false;
  public var canInteract(get, set):Bool;
  public var _canInteract:Bool = false;

  public function get_canInteract():Bool
  {
    return _canInteract;
  }

  public function set_canInteract(value:Bool):Bool
  {
    _canInteract = value;
  ...
  public function createMenuButtion(name:String, atlas:String, callback:Void->Void):Void
  {
