 ...
 */
class ScriptedStickerPack extends funkin.ui.transition.stickers.StickerPack {
  //! mock calls
   ...
   * @param className Name of the target class extending ScriptedStickerPack type
   * @param args List of argument of a scripted constructor. olny the first one seems to work?
   * @return ScriptedStickerPack
   */
  public static function init(className:String,...args:Any):ScriptedStickerPack {
    return null;
  }
  /**
  ...
  public function polymodExecFunc(funcName:String, args:Array<Dynamic> = null):Dynamic {
   ...
   /**
    * Returns a list of all the scripted classes which extend ScriptedStickerPack.
