...
class FunkinPreloader extends FlxBasePreloader
{
  ...
  public function makeText(txtX:Float, txtY:Float, txt:String, color:Int):TextField
  {
  ...
  public function scaleAndCenter(bmp:Bitmap, scale:Float)
  {
   ...
   * @return Bool
   */
  public function isLandscapeFlipped():Bool
  {
   ...
   */
  public function renderDisplayFadeOut(elapsed:Float):Float
  {
